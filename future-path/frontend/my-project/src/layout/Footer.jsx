...
const Footer = () => {
    return (
        <div className='bottom-0 left-0 w-full '>
            <div className='shadow-3xl rounded-t-3xl text-white mt-80 pattern-wavy pattern-sky-900 pattern-bg-sky-800  pattern-size-5 pattern-opacity-100'>
                <div className='p-10'>
                    ...
                    <div className='flex justify-evenly'>
                        ...
                        <div>
                            ...
                            <div className='text-sm '>
                                ...
                                <div className='flex align-middle'>
                                        <img src={Instagram} alt="" className='w-10' />
                                    <a href="https://www.instagram.com/elvin_markho/">
                                        <h3 className='p-2'>
                                            elvin_markho
                                        </h3>
                                    </a>
                                ...
                                <div className='flex align-middle'>
                                        <img src={Instagram} alt="" className='w-10' />
                                    <a href="https://www.instagram.com/fvn_igs/">
                                        <h3 className='p-2'>
                                            fvn_igs
                                        </h3>
                                    </a>
