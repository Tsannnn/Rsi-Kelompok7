            ...
            <div className='w-1/2  flex flex-col p-28'>
                ...
                <div className="bg-white border p-7 rounded-xl shadow-md w-99">
                    ...
                    <form className="mt-4" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="w-full bg-sky-600 text-white p-2 rounded-xl hover:bg-sky-700 active:translate-y-1" >
                            Masuk
                        </button>
                        ...
                        <div class="py-3 flex items-center text-sm text-gray-800 before:flex-1 before:border-t before:border-gray-200 before:me-5 after:flex-1 after:border-t after:border-gray-200 after:ms-6 dark:before:border-gray-300 dark:after:border-gray-300">atau</div>
