...
const LandingPage = () => {
    return (
        <div>
            <div>
                <div className='shadow-md shadow-gray-500 pattern-wavy pattern-blue-500 pattern-bg-sky-700 pattern-size-5 pattern-opacity-100'>
                    <div 
                    className='flex justify-between p-5 sticky top-0 backdrop-blur-sm'>
                        ...
                        <div>
                            ...
                            <Link to="/signin"><button className='p-3 rounded-md border bg-transparent font-semibold text-white hover:-translate-y-1'>Masuk</button></Link>
                        </div>
                    </div>
            ...
            <div className='mt-20 '>
                ...
                <div>
                    <div className='flex justify-evenly mt-10 snap-y '>
                        <div className='  border shadow-md p-2 rounded-xl w-[300px] cursor-pointer hover:scale-105 snap-center'>
